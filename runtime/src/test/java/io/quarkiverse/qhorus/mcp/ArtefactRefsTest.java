...
import io.quarkiverse.qhorus.runtime.mcp.QhorusMcpTools.MessageSummary;
...
class ArtefactRefsTest {
    ...
    void nullArtefactRefsStoredAsNullNotEmptyString() {
        ...
        Message msg = Message.<Message> find("channelId = ?1",
                io.quarkiverse.qhorus.runtime.channel.Channel.<io.quarkiverse.qhorus.runtime.channel.Channel> find("name",
                        "arefs-ch-7")
                        .firstResult().id)
                .firstResult();
