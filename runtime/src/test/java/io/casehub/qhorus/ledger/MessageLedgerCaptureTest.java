...
class MessageLedgerCaptureTest {
    ...
    void sendQuery_createsLedgerEntry() {
        ...
        tools.sendMessage("mlc-query-1", "agent-a", "query", "How many orders today?", "corr-mlc-q1", null, null, null, null, null, null, null);
        ...
        assertEquals("corr-mlc-q1", e.correlationId);
    ...
    void sendCommand_createsLedgerEntry() {
        ...
        tools.sendMessage("mlc-cmd-1", "agent-a", "command", "Generate the monthly report", "corr-mlc-c1", null, null, null, null, null, null, null);
    ...
    void sendResponse_createsLedgerEntry() {
        ...
        var q = tools.sendMessage("mlc-resp-1", "agent-a", "query", "Status?", "corr-r1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-resp-1", "agent-b", "response", "All good", "corr-r1", q.messageId(), null, null, null, null, null, null);
    ...
    void sendStatus_createsLedgerEntry() {
        ...
        tools.sendMessage("mlc-status-1", "agent-a", "command", "Run migration", "corr-s1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-status-1", "agent-a", "status", "50% complete", "corr-s1", null, null, null, null, null, null, null);
    ...
    void sendDecline_createsLedgerEntry() {
        ...
        var cmdD1 = tools.sendMessage("mlc-dec-1", "agent-a", "command", "Delete all records", "corr-d1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-dec-1", "agent-b", "decline", "I do not have write permissions", "corr-d1", cmdD1.messageId(), null, null, null, null, null, null);
    ...
    void sendHandoff_createsLedgerEntry() {
        ...
        var cmdH1 = tools.sendMessage("mlc-hand-1", "agent-a", "command", "Audit the accounts", "corr-h1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-hand-1", "agent-b", "handoff", "passing to agent-c", "corr-h1", cmdH1.messageId(), null, "instance:agent-c", null, null, null, null);
    ...
    void sendDone_createsLedgerEntry() {
        ...
        var cmdDone1 = tools.sendMessage("mlc-done-1", "agent-a", "command", "Process refunds", "corr-done1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-done-1", "agent-b", "done", "All 42 refunds processed", "corr-done1", cmdDone1.messageId(), null, null, null, null, null, null);
    ...
    void sendFailure_createsLedgerEntry() {
        ...
        var cmdFail1 = tools.sendMessage("mlc-fail-1", "agent-a", "command", "Run batch job", "corr-fail1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-fail-1", "agent-b", "failure", "Database connection lost", "corr-fail1", cmdFail1.messageId(), null, null, null, null, null, null);
    ...
    void multipleMessages_sequenceNumbersIncrement() {
        ...
        var cmdSeq1 = tools.sendMessage("mlc-seq-1", "agent-a", "command", "Go", "corr-seq1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-seq-1", "agent-a", "status", "Working", "corr-seq1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-seq-1", "agent-b", "done", "Done", "corr-seq1", cmdSeq1.messageId(), null, null, null, null, null, null);
    ...
    void sequenceNumbers_independentAcrossChannels() {
        ...
        tools.sendMessage("mlc-seq-2a", "agent-a", "command", "X", null, null, null, null, null, null, null, null);
        tools.sendMessage("mlc-seq-2b", "agent-b", "command", "Y", null, null, null, null, null, null, null, null);
    ...
    void commandThenDone_donePointsToCommand() {
        ...
        var cmdCd1 = tools.sendMessage("mlc-causal-done-1", "agent-a", "command", "Run report", "corr-cd1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-causal-done-1", "agent-b", "done", "Report delivered", "corr-cd1", cmdCd1.messageId(), null, null, null, null, null, null);
    ...
    void commandThenFailure_failurePointsToCommand() {
        ...
        var cmdCf1 = tools.sendMessage("mlc-causal-fail-1", "agent-a", "command", "Run migration", "corr-cf1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-causal-fail-1", "agent-b", "failure", "DB error", "corr-cf1", cmdCf1.messageId(), null, null, null, null, null, null);
    ...
    void commandThenDecline_declinePointsToCommand() {
        ...
        var cmdCdec1 = tools.sendMessage("mlc-causal-dec-1", "agent-a", "command", "Delete everything", "corr-cdec1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-causal-dec-1", "agent-b", "decline", "Out of scope", "corr-cdec1", cmdCdec1.messageId(), null, null, null, null, null, null);
    ...
    void commandHandoffDone_fullChain() {
        ...
        var cmdChain1 = tools.sendMessage("mlc-causal-chain-1", "agent-a", "command", "Audit", "corr-chain1", null, null, null, null, null, null, null);
        var hofChain1 = tools.sendMessage("mlc-causal-chain-1", "agent-b", "handoff", "delegating to agent-c", "corr-chain1", cmdChain1.messageId(), null, "instance:agent-c", null, null, null, null);
        tools.sendMessage("mlc-causal-chain-1", "agent-c", "done", "Audit complete", "corr-chain1", hofChain1.messageId(), null, null, null, null, null, null);
    ...
    void doneWithNoCorrelationId_causedByEntryIdNull() {
        ...
        tools.sendMessage("mlc-causal-nocorr-1", "agent-a", "status", "Update with no correlation", null, null, null, null, null, null, null, null);
    ...
    void listEntries_typeFilter_commandAndDone_excludesOtherTypes() {
        ...
        var cmdFt1 = tools.sendMessage("mlc-filter-type-1", "agent-a", "command", "Go", "corr-ft1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-filter-type-1", "agent-a", "status", "Working", "corr-ft1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-filter-type-1", "agent-b", "done", "Done", "corr-ft1", cmdFt1.messageId(), null, null, null, null, null, null);
    ...
    void listEntries_agentFilter_returnsOnlyThatAgent() {
        ...
        var cmdFa1 = tools.sendMessage("mlc-filter-agent-1", "agent-a", "command", "Go", "corr-fa1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-filter-agent-1", "agent-b", "done", "Done", "corr-fa1", cmdFa1.messageId(), null, null, null, null, null, null);
    ...
    void listEntries_afterSequenceCursor_returnsLaterEntries() {
        ...
        var cmdCur1 = tools.sendMessage("mlc-cursor-1", "agent-a", "command", "Go", "corr-cur1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-cursor-1", "agent-a", "status", "Working", "corr-cur1", null, null, null, null, null, null, null);
        tools.sendMessage("mlc-cursor-1", "agent-b", "done", "Done", "corr-cur1", cmdCur1.messageId(), null, null, null, null, null, null);
    ...
    void sendMessage_allTypesProduceLedgerEntry() {
        ...
        var q = tools.sendMessage("mlc-all-types-1", "agent-a", "query", "Status?", corr, null, null, null, null, null, null, null);
        tools.sendMessage("mlc-all-types-1", "agent-b", "response", "Good", corr, q.messageId(), null, null, null, null, null, null);
        var cmd = tools.sendMessage("mlc-all-types-1", "agent-a", "command", "Go", corr, null, null, null, null, null, null, null);
        tools.sendMessage("mlc-all-types-1", "agent-b", "status", "Working", corr, null, null, null, null, null, null, null);
        tools.sendMessage("mlc-all-types-1", "agent-b", "done", "Done", corr, cmd.messageId(), null, null, null, null, null, null);
    ...
    private void setup(final String channel, final String... agents) {
        tools.createChannel(channel, "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
