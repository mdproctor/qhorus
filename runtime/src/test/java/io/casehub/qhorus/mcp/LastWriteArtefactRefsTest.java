...
class LastWriteArtefactRefsTest {
    ...
    void lastWriteOverwriteReplacesArtefactRefsNotAccumulatesThem() {
        tools.createChannel("lw-refs-replace", "LAST_WRITE artefact refs", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("lw-refs-replace", "alice", "status", "v1", null, null, List.of(ref1.artefactId().toString(), ref2.artefactId().toString()), null, null, null, null, null);

        // Overwrite: attach only ref3 — ref1 and ref2 must be GONE
        DispatchResult overwrite = tools.sendMessage("lw-refs-replace", "alice", "status", "v2", null, null, List.of(ref3.artefactId().toString()), null, null, null, null, null);

        // The returned DispatchResult should reflect only ref3
    ...
    void lastWriteOverwriteWithNullRefsClearsStoredRefs() {
        tools.createChannel("lw-refs-clear", "LAST_WRITE clear refs", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ArtefactDetail ref = tools.shareArtefact("lw-ref-clear-data", "d", "alice", "content", false, true);

        // First write: attach ref
        tools.sendMessage("lw-refs-clear", "alice", "status", "v1", null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with null refs — stored refs must be cleared
        DispatchResult overwrite = tools.sendMessage("lw-refs-clear", "alice", "status", "v2", null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteWithUnknownArtefactRefIsRejected() {
        tools.createChannel("lw-refs-bad-overwrite", "LAST_WRITE bad ref test", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        // First write succeeds (no refs)
        tools.sendMessage("lw-refs-bad-overwrite", "alice", "status", "v1", null, null, null, null, null, null, null, null);
        ...
        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("lw-refs-bad-overwrite", "alice", "status", "v2", null, null, List.of(fakeUuid), null, null, null, null, null),
    ...
    void lastWriteOverwriteWithEmptyRefsListClearsStoredRefs() {
        tools.createChannel("lw-refs-empty-list", "LAST_WRITE empty list", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ArtefactDetail ref = tools.shareArtefact("lw-ref-empty-data", "d", "alice", "content", false, true);

        // First write: attach ref
        tools.sendMessage("lw-refs-empty-list", "alice", "status", "v1", null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with empty list — stored refs must be cleared
        DispatchResult overwrite = tools.sendMessage("lw-refs-empty-list", "alice", "status", "v2", null, null, List.of(), null, null, null, null, null);
