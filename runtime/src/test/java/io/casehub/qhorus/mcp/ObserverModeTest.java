...
class ObserverModeTest {
    ...
    void registerReadOnlyInstanceCreatesInstanceRecord() {
        tools.createChannel("obs-reg-1", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void readOnlyInstanceAppearsInListInstances() {
        tools.createChannel("obs-reg-2", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void readOnlyInstanceCannotSendMessages() {
        tools.createChannel("obs-send-1", "Test", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("readonly-obs", "Read-only observer", List.of(), null, true);

        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("obs-send-1", "readonly-obs", "status", "intrude", null, null, null, null, null, null, null, null),
    ...
    void readOnlyInstanceCannotSendEventMessages() {
        tools.createChannel("obs-send-2", "Test", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("obs-send-2", "readonly-obs-2", "event", "audit", null, null, null, null, null, null, null, null),
    ...
    void readOnlyInstanceCanReadEventMessagesViaIncludeEvents() {
        tools.createChannel("obs-read-1", "Monitored channel", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("obs-read-1", "agent-a", "status", "status update", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-1", "agent-b", "event", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-1", "agent-a", "command", "some request", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-1", "system", "event", null, null, null, null, null, null, null, null, null);
    ...
    void checkMessagesWithoutIncludeEventsExcludesEvents() {
        tools.createChannel("obs-read-2", "Test", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        tools.sendMessage("obs-read-2", "system", "event", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-2", "system", "status", "status-1", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-2", "system", "event", null, null, null, null, null, null, null, null, null);
    ...
    void checkMessagesWithIncludeEventsPagination() {
        tools.createChannel("obs-read-3", "Paginated", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        tools.sendMessage("obs-read-3", "system", "event", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-3", "system", "event", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-read-3", "system", "event", null, null, null, null, null, null, null, null, null);
    ...
    void reRegisterClearsReadOnlyFlag() {
        tools.createChannel("obs-dereg-2", "Test", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("was-observer", "Was observer", List.of(), null, true);

        // Blocked as read_only
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("obs-dereg-2", "was-observer", "status", "blocked", null, null, null, null, null, null, null, null));
        ...
        assertDoesNotThrow(
                () -> tools.sendMessage("obs-dereg-2", "was-observer", "status", "now allowed", null, null, null, null, null, null, null, null),
    ...
    void e2eDashboardObserverWatchesAgentWorkflow() {
        tools.createChannel("obs-e2e-1", "Agent work channel", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        var cmdA = tools.sendMessage("obs-e2e-1", "agent-alpha", "command", "job A", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-e2e-1", "agent-beta", "response", "job A done", cmdA.correlationId(), cmdA.messageId(), null, null, null, null, null, null);
        tools.sendMessage("obs-e2e-1", "system", "event", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-e2e-1", "agent-alpha", "status", "starting job B", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-e2e-1", "system", "event", null, null, null, null, null, null, null, null, null);
    ...
    void e2eReadOnlyBlockedDoesNotAffectRegularSenders() {
        tools.createChannel("obs-e2e-2", "Mixed channel", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("worker", "Worker agent", List.of(), null, false);
        tools.register("watcher", "Watcher", List.of(), null, true);

        // Worker sends freely
        tools.sendMessage("obs-e2e-2", "worker", "command", "task", null, null, null, null, null, null, null, null);
        tools.sendMessage("obs-e2e-2", "worker", "status", "in progress", null, null, null, null, null, null, null, null);

        // Watcher cannot send
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("obs-e2e-2", "watcher", "status", "observer intrusion", null, null, null, null, null, null, null, null));
