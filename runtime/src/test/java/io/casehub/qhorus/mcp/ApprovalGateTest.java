...
class ApprovalGateTest {
    ...
    void respondToApprovalCreatesResponseMessageInChannel() {
        tools.createChannel("ag-respond-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void respondToApprovalSenderIsHuman() {
        tools.createChannel("ag-respond-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void respondToApprovalSetsCorrelationId() {
        tools.createChannel("ag-respond-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsShowsRegisteredApproval() {
        tools.createChannel("ag-list-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsResolvesChannelId() {
        tools.createChannel("ag-list-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsShowsExpiresAt() {
        tools.createChannel("ag-list-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsOrdersByExpiresAtAscending() {
        tools.createChannel("ag-list-4", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void requestApprovalFindsPreSeededResponse() {
        tools.createChannel("ag-req-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();

        // Send QUERY first so we have a messageId to reply to
        DispatchResult query = tools.sendMessage("ag-req-1", "agent", "query", "please approve this", corrId, null, null, null, null, null, null, null);

        // Pre-seed the human's response with inReplyTo pointing to the query
        tools.sendMessage("ag-req-1", "human", "response", "approved by human", corrId, query.messageId(), null, null, null, null, null, null);
    ...
    void requestApprovalCreatesRequestMessageInChannel() {
        tools.createChannel("ag-req-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();

        // Send QUERY + pre-seed response so wait doesn't block long
        DispatchResult query = tools.sendMessage("ag-req-2", "agent", "query", "needs approval", corrId, null, null, null, null, null, null, null);
        tools.sendMessage("ag-req-2", "human", "response", "ok", corrId, query.messageId(), null, null, null, null, null, null);
    ...
    void requestApprovalUsesProvidedCorrelationId() {
        tools.createChannel("ag-req-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();

        DispatchResult query = tools.sendMessage("ag-req-3", "agent", "query", "approve", corrId, null, null, null, null, null, null, null);
        tools.sendMessage("ag-req-3", "human", "response", "ok", corrId, query.messageId(), null, null, null, null, null, null);
    ...
    void requestApprovalTimesOutGracefully() {
        tools.createChannel("ag-req-4", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void e2eAgentRequestsHumanApproves() {
        tools.createChannel("ag-e2e-1", "Human Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void e2eRequestApprovalThenRespondReturnsToCaller() {
        tools.createChannel("ag-e2e-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();

        // 1. Send QUERY first so we have messageId for inReplyTo
        DispatchResult query = tools.sendMessage("ag-e2e-2", "agent", "query", "Deploy to production?", corrId, null, null, null, null, null, null, null);

        // 2. Pre-seed the human's response with inReplyTo
        tools.sendMessage("ag-e2e-2", "human", "response", "Yes, deploy it!", corrId, query.messageId(), null, null, null, null, null, null);
    ...
    void e2eMultiplePendingCommitmentsDiscoveredAndAnswered() {
        tools.createChannel("ag-e2e-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId1 = UUID.randomUUID().toString();
        String corrId2 = UUID.randomUUID().toString();
