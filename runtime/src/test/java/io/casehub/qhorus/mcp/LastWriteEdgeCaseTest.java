...
class LastWriteEdgeCaseTest {
    ...
    void lastWriteOverwriteAlwaysReturnsParentReplyCountZero() {
        tools.createChannel("lw-edge-1", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null); // request channel
        tools.createChannel("lw-edge-2", "LAST_WRITE state", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        // Send a request in the APPEND channel
        DispatchResult request = tools.sendMessage("lw-edge-1", "alice", "query", "Q?", null, null, null, null, null, null, null, null);

        // First LAST_WRITE write with inReplyTo pointing to the request
        tools.sendMessage("lw-edge-2", "alice", "status", "v1", null, request.messageId(), null, null, null, null, null, null);

        // Overwrite — same sender, new content. Returns DispatchResult with parentReplyCount.
        DispatchResult overwrite = tools.sendMessage("lw-edge-2", "alice", "status", "v2", null, request.messageId(), null, null, null, null, null, null);
    ...
    void lastWriteOverwriteChangingInReplyToLinksMessageButDoesNotIncrementParentReplyCountField() {
        tools.createChannel("lw-edge-3-parent", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.createChannel("lw-edge-3", "LAST_WRITE state", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        DispatchResult parentMsg = tools.sendMessage("lw-edge-3-parent", "orchestrator", "command", "do task", null, null, null, null, null, null, null, null);

        // First LAST_WRITE write — no inReplyTo (goes through messageService.send())
        tools.sendMessage("lw-edge-3", "alice", "status", "v1 no parent", null, null, null, null, null, null, null, null);

        // Overwrite — now links to parentMsg; goes through the overwrite path, NOT messageService.send()
        tools.sendMessage("lw-edge-3", "alice", "status", "v2 with parent", null, parentMsg.messageId(), null, null, null, null, null, null);
        ...
        DispatchResult secondWrite = tools.sendMessage("lw-edge-3", "alice", "status", "v3", null, parentMsg.messageId(), null, null, null, null, null, null);
    ...
    void lastWriteOverwriteMessageIdIsStableAcrossMultipleWrites() {
        tools.createChannel("lw-edge-4", "LAST_WRITE", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        DispatchResult first = tools.sendMessage("lw-edge-4", "alice", "status", "v1", null, null, null, null, null, null, null, null);
        tools.sendMessage("lw-edge-4", "alice", "status", "v2", null, null, null, null, null, null, null, null);
        DispatchResult third = tools.sendMessage("lw-edge-4", "alice", "status", "v3", null, null, null, null, null, null, null, null);
    ...
    void lastWriteEventMessageFromFirstSenderBlocksSecondSender() {
        tools.createChannel("lw-edge-5", "LAST_WRITE", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        // alice sends an EVENT message — this is the only message in the channel
        tools.sendMessage("lw-edge-5", "alice", "event", null, null, null, null, null, null, null, null, null);
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("lw-edge-5", "bob", "status", "bob wants in", null, null, null, null, null, null, null, null),
    ...
    void lastWriteChannelAfterOwnerOverwritesWithEventTypeAppearsEmpty() {
        tools.createChannel("lw-edge-6", "LAST_WRITE", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        // Write STATUS first (visible)
        tools.sendMessage("lw-edge-6", "alice", "status", "visible state", null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("lw-edge-6", "alice", "event", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteClearsCorrelationIdWhenNewWriteHasNone() {
        tools.createChannel("lw-edge-7", "LAST_WRITE", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.sendMessage("lw-edge-7", "alice", "status", "v1", "initial-corr", null, null, null, null, null, null, null);

        // Overwrite with no correlationId — for non-REQUEST type, corrId stays null
        tools.sendMessage("lw-edge-7", "alice", "status", "v2", null, null, null, null, null, null, null, null);
