...
class LastWriteEdgeCaseTest {
    ...
    void lastWriteOverwriteAlwaysReturnsParentReplyCountZero() {
        ...
        tools.sendMessage("lw-edge-2", "alice", "status", "v1", null, request.messageId(), null, null, null, null, null);

        // Overwrite — same sender, new content. Returns DispatchResult with parentReplyCount.
        DispatchResult overwrite = tools.sendMessage("lw-edge-2", "alice", "status", "v2", null, request.messageId(), null, null, null, null, null);
    ...
    void lastWriteOverwriteChangingInReplyToLinksMessageButDoesNotIncrementParentReplyCountField() {
        ...
        tools.sendMessage("lw-edge-3", "alice", "status", "v1 no parent", null, null, null, null, null, null, null);

        // Overwrite — now links to parentMsg; goes through the overwrite path, NOT messageService.send()
        tools.sendMessage("lw-edge-3", "alice", "status", "v2 with parent", null, parentMsg.messageId(), null, null, null, null, null);
        ...
        DispatchResult secondWrite = tools.sendMessage("lw-edge-3", "alice", "status", "v3", null, parentMsg.messageId(), null, null, null, null, null);
    ...
    void lastWriteOverwriteMessageIdIsStableAcrossMultipleWrites() {
        ...
        DispatchResult third = tools.sendMessage("lw-edge-4", "alice", "status", "v3", null, null, null, null, null, null, null);
    ...
    void lastWriteEventMessageFromFirstSenderBlocksSecondSender() {
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("lw-edge-5", "bob", "status", "bob wants in", null, null, null, null, null, null, null),
    ...
    void lastWriteOverwriteClearsCorrelationIdWhenNewWriteHasNone() {
        ...
        tools.sendMessage("lw-edge-7", "alice", "status", "v2", null, null, null, null, null, null, null);
