...
class MessagingEdgeCaseTest {
    ...
    void replyCountIncrementsCorrectlyForMultipleReplies() {
        ...
        // First reply
        DispatchResult r1 = tools.sendMessage("msg-edge-replies", "bob", "response", "A1", request.correlationId(), request.messageId(), null, null, null, null, null, null);
        assertEquals(1, r1.parentReplyCount(), "parentReplyCount should be 1 after first reply");

        // Second reply
        DispatchResult r2 = tools.sendMessage("msg-edge-replies", "carol", "response", "A2", request.correlationId(), request.messageId(), null, null, null, null, null, null);
        assertEquals(2, r2.parentReplyCount(), "parentReplyCount should be 2 after second reply");

        // Third reply
        DispatchResult r3 = tools.sendMessage("msg-edge-replies", "dave", "response", "A3", request.correlationId(), request.messageId(), null, null, null, null, null, null);
    ...
    void checkMessagesSenderFilterIsAppliedInQueryNotPostLimit() {
        ...
        for (int i = 0; i < 18; i++) {
            tools.sendMessage("msg-edge-sender-limit", "bob", "status", "bob msg " + i, null, null, null, null, null, null, null, null);
        }
        tools.sendMessage("msg-edge-sender-limit", "alice", "status", "alice-1", null, null, null, null, null, null, null, null);
        tools.sendMessage("msg-edge-sender-limit", "alice", "status", "alice-2", null, null, null, null, null, null, null, null);
        tools.sendMessage("msg-edge-sender-limit", "alice", "status", "alice-3", null, null, null, null, null, null, null, null);
