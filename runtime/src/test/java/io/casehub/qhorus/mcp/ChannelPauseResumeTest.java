...
class ChannelPauseResumeTest {
    ...
    void newChannelIsNotPaused() {
        ChannelDetail detail = tools.createChannel("pr-new-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void pauseChannelSetsPausedTrue() {
        tools.createChannel("pr-pause-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void pauseChannelIsIdempotent() {
        tools.createChannel("pr-pause-2", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void resumeChannelSetsPausedFalse() {
        tools.createChannel("pr-resume-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void resumeUnpausedChannelIsIdempotent() {
        tools.createChannel("pr-resume-2", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void sendMessageOnPausedChannelThrows() {
        tools.createChannel("pr-send-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void sendMessageOnResumedChannelSucceeds() {
        tools.createChannel("pr-send-2", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void checkMessagesOnPausedChannelReturnsEmptyWithStatus() {
        tools.createChannel("pr-check-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void checkMessagesOnResumedChannelReturnsMessages() {
        tools.createChannel("pr-check-2", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void channelDetailPausedFieldReflectsCurrentState() {
        tools.createChannel("pr-detail-1", "Test", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void fullPauseResumeCycle() {
        tools.createChannel("pr-cycle-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null);
    ...
    void e2eMultipleAgentsBlockedByPause() {
        tools.createChannel("pr-e2e-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null);
