...
class ChannelPauseResumeTest {
    ...
    void newChannelIsNotPaused() {
        ChannelDetail detail = tools.createChannel("pr-new-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void pauseChannelSetsPausedTrue() {
        tools.createChannel("pr-pause-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void pauseChannelIsIdempotent() {
        tools.createChannel("pr-pause-2",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void resumeChannelSetsPausedFalse() {
        tools.createChannel("pr-resume-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void resumeUnpausedChannelIsIdempotent() {
        tools.createChannel("pr-resume-2",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void sendMessageOnPausedChannelThrows() {
        tools.createChannel("pr-send-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.pauseChannel("pr-send-1", null);

        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("pr-send-1", "alice", "status", "hello", null, null, null, null, null, null, null, null));
    ...
    void sendMessageOnResumedChannelSucceeds() {
        tools.createChannel("pr-send-2",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.pauseChannel("pr-send-2", null);
        tools.resumeChannel("pr-send-2", null);

        assertDoesNotThrow(
                () -> tools.sendMessage("pr-send-2", "alice", "status", "hello", null, null, null, null, null, null, null, null));
    }
    ...
    void checkMessagesOnPausedChannelReturnsEmptyWithStatus() {
        tools.createChannel("pr-check-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void checkMessagesOnResumedChannelReturnsMessages() {
        tools.createChannel("pr-check-2",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void channelDetailPausedFieldReflectsCurrentState() {
        tools.createChannel("pr-detail-1",  "Test",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void fullPauseResumeCycle() {
        tools.createChannel("pr-cycle-1",  "Test",  "APPEND",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("pr-cycle-1", "alice", "status", "msg2", null, null, null, null, null, null, null, null));
        ...
        assertDoesNotThrow(() -> tools.sendMessage("pr-cycle-1", "alice", "status", "msg3", null, null, null, null, null, null, null, null));
    ...
    void e2eMultipleAgentsBlockedByPause() {
        tools.createChannel("pr-e2e-1",  "Test",  "APPEND",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        tools.sendMessage("pr-e2e-1", "alice-agent", "command", "alice work", null, null, null, null, null, null, null, null);
        tools.sendMessage("pr-e2e-1", "bob-agent", "status", "bob work", null, null, null, null, null, null, null, null);
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("pr-e2e-1", "alice-agent", "status", "update", null, null, null, null, null, null, null, null));
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("pr-e2e-1", "bob-agent", "status", "update", null, null, null, null, null, null, null, null));

        // Human resumes
        tools.resumeChannel("pr-e2e-1", null);

        // Both agents can send again
        assertDoesNotThrow(() -> tools.sendMessage("pr-e2e-1", "alice-agent", "status", "alice resumes", null, null, null, null, null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("pr-e2e-1", "bob-agent", "status", "bob resumes", null, null, null, null, null, null, null, null));
