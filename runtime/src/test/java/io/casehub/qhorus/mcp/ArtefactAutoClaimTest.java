...
class ArtefactAutoClaimTest {
    ...
    void sendMessageWithArtefactRefsAutoClaimsForSender() {
        tools.createChannel("autoclaim-1", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("autoclaim-1", "claimer-agent", "command", "process this doc", null, null, List.of(artId), null, null, null, null, null);
    ...
    void sendMessageWithoutArtefactRefsDoesNotClaim() {
        tools.createChannel("autoclaim-2", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("autoclaim-2", "no-ref-agent", "status", "no artefacts here", null, null, null, null, null, null, null, null);
    ...
    void responseAutoReleasesClaimsFromOriginalQuery() {
        tools.createChannel("autorel-1", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        DispatchResult queryResult = tools.sendMessage("autorel-1", "asker", "query", "what about this doc?", null, null, List.of(artId), null, null, null, null, null);
        ...
        tools.sendMessage("autorel-1", "answerer", "response", "here is the answer", corrId, queryResult.messageId(), null, null, null, null, null, null);
    ...
    void doneAutoReleasesClaimsFromOriginalCommand() {
        tools.createChannel("autorel-2", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-2", "commander", "command", "process this", null, null, List.of(artId), null, null, null, null, null);
        ...
        tools.sendMessage("autorel-2", "worker", "done", "completed", corrId, cmdResult.messageId(), null, null, null, null, null, null);
    ...
    void declineAutoReleasesClaimsFromOriginalQuery() {
        tools.createChannel("autorel-3", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        DispatchResult queryResult = tools.sendMessage("autorel-3", "asker-2", "query", "what about this?", null, null, List.of(artId), null, null, null, null, null);
        String corrId = queryResult.correlationId();

        assertFalse(tools.isGcEligible(artId), "artefact should be claimed after QUERY");

        // DECLINE auto-releases
        tools.sendMessage("autorel-3", "decliner", "decline", "cannot help with that", corrId, queryResult.messageId(), null, null, null, null, null, null);
    ...
    void failureAutoReleasesClaimsFromOriginalCommand() {
        tools.createChannel("autorel-4", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-4", "cmd-agent", "command", "do this", null, null, List.of(artId), null, null, null, null, null);
        String corrId = cmdResult.correlationId();

        // FAILURE auto-releases
        tools.sendMessage("autorel-4", "fail-agent", "failure", "could not complete", corrId, cmdResult.messageId(), null, null, null, null, null, null);
    ...
    void handoffDoesNotAutoReleaseClaims() {
        tools.createChannel("autorel-5", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-5", "handoff-cmd", "command", "handle this", null, null, List.of(artId), null, null, null, null, null);
        String corrId = cmdResult.correlationId();

        assertFalse(tools.isGcEligible(artId), "artefact should be claimed after COMMAND");

        // HANDOFF delegates but does NOT release
        tools.sendMessage("autorel-5", "handoff-agent", "handoff", "passing to someone else", corrId, cmdResult.messageId(), null, "instance:someone-else", null, null, null, null);
    ...
    void autoClaimIsIdempotent() {
        tools.createChannel("autoclaim-idem", "Test channel", null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "first", null, null, List.of(artId), null, null, null, null, null);
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "second", null, null, List.of(artId), null, null, null, null, null);
