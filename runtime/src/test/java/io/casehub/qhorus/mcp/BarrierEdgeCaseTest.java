...
class BarrierEdgeCaseTest {
    ...
    void barrierEventMessagesAccumulateAcrossCycles() {
        tools.createChannel("bar-edge-1", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null);
    ...
    void barrierContributorDeclarationWithWhitespaceIsNormalized() {
        ...
        tools.createChannel("bar-edge-2", "BARRIER channel", "BARRIER", " alice , bob ", null, null, null, null, null, null, null, null, null);
    ...
    void barrierSenderWithTrailingSpaceDoesNotMatchTrimmedContributor() {
        ...
        tools.createChannel("bar-edge-3", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null);
    ...
    void barrierIgnoresAfterIdAndSenderParameters() {
        tools.createChannel("bar-edge-4", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null);
    ...
    void barrierContributorWritingMultipleTimesCountsOnce() {
        tools.createChannel("bar-edge-5", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null);
    ...
    void barrierWithSingleContributor() {
        tools.createChannel("bar-edge-6", "BARRIER channel", "BARRIER", "alice", null, null, null, null, null, null, null, null, null);
    ...
    void barrierLeftoverEventMessagesFromMonitorDontPoisonSubsequentCycles() {
        tools.createChannel("bar-edge-7", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null);
