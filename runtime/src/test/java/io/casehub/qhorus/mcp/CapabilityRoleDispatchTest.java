...
class CapabilityRoleDispatchTest {
    ...
    void capabilityTargetedMessageVisibleToAgentWithMatchingTag() {
        tools.createChannel("crd-cap-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("reviewer-alice", "Code reviewer", List.of("capability:code-review"), null, null);
        tools.sendMessage("crd-cap-1", "sender", "command", "review this", null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageHiddenFromAgentWithoutMatchingTag() {
        tools.createChannel("crd-cap-2", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("python-bob", "Python dev", List.of("capability:python"), null, null);
        tools.sendMessage("crd-cap-2", "sender", "command", "review this", null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageHiddenFromUnregisteredReader() {
        tools.createChannel("crd-cap-3", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        // No register call — reader is unknown to the system
        tools.sendMessage("crd-cap-3", "sender", "command", "review this", null, null, null, "capability:code-review", null, null, null, null);
    ...
    void broadcastMessageVisibleToCapabilityReader() {
        tools.createChannel("crd-cap-4", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("cap-reader", "Agent", List.of("capability:code-review"), null, null);
        tools.sendMessage("crd-cap-4", "sender", "status", "broadcast", null, null, null, null, null, null, null, null);
    ...
    void roleTargetedMessageVisibleToAllAgentsWithMatchingRoleTag() {
        tools.createChannel("crd-role-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        tools.sendMessage("crd-role-1", "sender", "command", "needs review", null, null, null, "role:reviewer", null, null, null, null);
    ...
    void roleTargetedMessageHiddenFromAgentWithoutRoleTag() {
        tools.createChannel("crd-role-2", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("non-reviewer", "Not a reviewer", List.of("capability:python"), null, null);
        tools.sendMessage("crd-role-2", "sender", "command", "needs review", null, null, null, "role:reviewer", null, null, null, null);
    ...
    void agentWithMultipleTagsSeesAllAddressedMessages() {
        tools.createChannel("crd-multi-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("full-alice", "Full-stack agent", List.of("capability:code-review", "role:reviewer"), null, null);
        tools.sendMessage("crd-multi-1", "sender", "command", "cap msg", null, null, null, "capability:code-review", null, null, null, null);
        tools.sendMessage("crd-multi-1", "sender", "command", "role msg", null, null, null, "role:reviewer", null, null, null, null);
        tools.sendMessage("crd-multi-1", "sender", "status", "broadcast", null, null, null, null, null, null, null, null);
    ...
    void capabilityTargetedReplyVisibleToAgentWithTag() {
        tools.createChannel("crd-rep-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("code-reviewer", "Code reviewer", List.of("capability:code-review"), null, null);
        DispatchResult parent = tools.sendMessage("crd-rep-1", "alice", "query", "question", null, null, null, null, null, null, null, null);
        tools.sendMessage("crd-rep-1", "bob", "response", "answer", parent.correlationId(), parent.messageId(), null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedReplyHiddenFromAgentWithoutTag() {
        tools.createChannel("crd-rep-2", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("non-reviewer", "Not a reviewer", List.of("capability:python"), null, null);
        DispatchResult parent = tools.sendMessage("crd-rep-2", "alice", "query", "question", null, null, null, null, null, null, null, null);
        tools.sendMessage("crd-rep-2", "bob", "response", "answer", parent.correlationId(), parent.messageId(), null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageFoundBySearchForAgentWithTag() {
        tools.createChannel("crd-srch-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("searcher", "Code reviewer", List.of("capability:code-review"), null, null);
        tools.sendMessage("crd-srch-1", "sender", "command", "searchable review request", null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageNotFoundBySearchForAgentWithoutTag() {
        tools.createChannel("crd-srch-2", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.register("non-searcher", "Python dev", List.of("capability:python"), null, null);
        tools.sendMessage("crd-srch-2", "sender", "command", "searchable review request", null, null, null, "capability:code-review", null, null, null, null);
