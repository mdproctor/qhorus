...
class ChannelRateLimitTest {
    ...
    void channelWithNoLimitsAllowsUnlimitedMessages() {
        tools.createChannel("rl-open-1", "Unlimited", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void createChannelDetailHasNullRateLimits() {
        ChannelDetail detail = tools.createChannel("rl-open-2", "No limits", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void messagesUnderPerChannelLimitPass() {
        tools.createChannel("rl-ch-1", "Per-channel limit", null, null, null, null, 3, null, null, null, null, null, null);
    ...
    void messageAtPerChannelLimitPasses() {
        tools.createChannel("rl-ch-2", "Per-channel limit", null, null, null, null, 2, null, null, null, null, null, null);
    ...
    void messageOverPerChannelLimitIsRejectedWithClearError() {
        tools.createChannel("rl-ch-3", "Per-channel limit", null, null, null, null, 2, null, null, null, null, null, null);
    ...
    void perChannelLimitCountsAcrossAllSenders() {
        tools.createChannel("rl-ch-4", "Per-channel limit", null, null, null, null, 2, null, null, null, null, null, null);
    ...
    void rejectedMessageDoesNotIncrementCount() {
        tools.createChannel("rl-ch-5", "Per-channel limit", null, null, null, null, 2, null, null, null, null, null, null);
    ...
    void messagesUnderPerInstanceLimitPass() {
        tools.createChannel("rl-inst-1", "Per-instance limit", null, null, null, null, null, 2, null, null, null, null, null);
    ...
    void messageOverPerInstanceLimitIsRejectedWithClearError() {
        tools.createChannel("rl-inst-2", "Per-instance limit", null, null, null, null, null, 2, null, null, null, null, null);
    ...
    void perInstanceLimitIsIsolatedBetweenSenders() {
        ...
        tools.createChannel("rl-inst-3", "Per-instance limit", null, null, null, null, null, 2, null, null, null, null, null);
    ...
    void perChannelLimitCanBeHitBeforePerInstanceLimit() {
        ...
        tools.createChannel("rl-both-1", "Both limits", null, null, null, null, 3, 5, null, null, null, null, null);
    ...
    void perInstanceLimitCanBeHitBeforePerChannelLimit() {
        ...
        tools.createChannel("rl-both-2", "Both limits", null, null, null, null, 10, 2, null, null, null, null, null);
    ...
    void eventMessagesBypassRateLimit() {
        tools.createChannel("rl-evt-1", "Rate limited", null, null, null, null, 1, null, null, null, null, null, null);
    ...
    void setChannelRateLimitsAppliesLimitsToExistingChannel() {
        tools.createChannel("rl-scrl-1", "Open initially", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void setChannelRateLimitsToNullRemovesLimits() {
        tools.createChannel("rl-scrl-2", "Limited", null, null, null, null, 1, null, null, null, null, null, null);
        // Hit the limit
    ...
    void createChannelDetailIncludesRateLimits() {
        ChannelDetail detail = tools.createChannel("rl-det-1", "Rate limited", null, null, null, null, 10, 3, null, null, null, null, null);
    ...
    void listChannelsIncludesRateLimits() {
        tools.createChannel("rl-det-2", "Rate limited", null, null, null, null, 5, 2, null, null, null, null, null);
    ...
    void e2eThreeSendersPerChannelLimit() {
        ...
        tools.createChannel("rl-e2e-1", "Shared budget", null, null, null, null, 4, null, null, null, null, null, null);
    ...
    void e2ePerInstanceLimitDoesNotAffectOtherSenders() {
        ...
        tools.createChannel("rl-e2e-2", "Per-instance only", null, null, null, null, null, 2, null, null, null, null, null);
    ...
    void e2eRateLimitAndWriteAclCoexist() {
        ...
        tools.createChannel("rl-e2e-3", "ACL + rate limit", null, null, "alice", null, 2, null, null, null, null, null, null);
