...
class DeleteChannelToolTest {
    ...
    void deleteChannel_withMessages_forceTrue_deletesAllAndReturnsCount() {
        ...
        QuarkusTransaction.requiringNew().run(() -> {
            ...
            messageService.dispatch(                    MessageDispatch.builder()
                    ...
                    .type(MessageType.STATUS)
                    .content("two")
                    .actorType(ActorTypeResolver.resolve("agent-b"))
                    .build());
        });
    ...
    void deleteChannel_withAdminList_authorizedCallerAllowed() {
        ...
        QuarkusTransaction.requiringNew().run(() -> {
            tools.createChannel(name, "Admin-guarded", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void deleteChannel_withOpenCommitment_forceTrue_succeeds() {
        ...
        QuarkusTransaction.requiringNew().run(() ->
                messageService.dispatch(                        MessageDispatch.builder()
                        ...
                        .content("do work")
                        .correlationId("corr-171-" + System.nanoTime())
                        .actorType(ActorTypeResolver.resolve("agent-a"))
                        .build()));
