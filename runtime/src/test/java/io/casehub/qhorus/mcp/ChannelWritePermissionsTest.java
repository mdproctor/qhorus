...
class ChannelWritePermissionsTest {
    ...
    void openChannelWithNoAclAllowsAnyWriter() {
        tools.createChannel("wp-open-1",  "Open channel",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void openChannelDetailHasNullAllowedWriters() {
        ChannelDetail detail = tools.createChannel("wp-open-2",  "Open",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void listedInstanceIdCanSend() {
        tools.createChannel("wp-iid-1",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void secondListedInstanceIdCanSend() {
        tools.createChannel("wp-iid-2",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void unlistedSenderRejectedWithClearError() {
        tools.createChannel("wp-iid-3",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void allowedWritersEntriesAreStripped() {
        ...
        tools.createChannel("wp-iid-4",  "ACL trimmed",  null,  null,  " alice , bob ",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void senderWithMatchingCapabilityTagCanWrite() {
        tools.createChannel("wp-cap-1",  "ACL by capability",  null,  null,  "capability:code-review",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("reviewer-alice", "Code reviewer", List.of("capability:code-review"), null, null);

        assertDoesNotThrow(
                () -> tools.sendMessage("wp-cap-1", "reviewer-alice", "status", "lgtm", null, null, null, null, null, null, null, null),
    ...
    void senderWithoutMatchingCapabilityTagIsRejected() {
        tools.createChannel("wp-cap-2",  "ACL by capability",  null,  null,  "capability:code-review",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("python-bob", "Python dev", List.of("capability:python"), null, null);

        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-cap-2", "python-bob", "status", "hello", null, null, null, null, null, null, null, null),
    ...
    void unregisteredSenderCannotMatchCapabilityTag() {
        tools.createChannel("wp-cap-3",  "ACL by capability",  null,  null,  "capability:code-review",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        // "ghost" is not registered — has no capability tags

        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-cap-3", "ghost", "status", "hello", null, null, null, null, null, null, null, null),
    ...
    void senderWithMatchingRoleTagCanWrite() {
        tools.createChannel("wp-role-1",  "ACL by role",  null,  null,  "role:reviewer",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("reviewer-carol", "Senior reviewer", List.of("role:reviewer"), null, null);

        assertDoesNotThrow(
                () -> tools.sendMessage("wp-role-1", "reviewer-carol", "status", "approved", null, null, null, null, null, null, null, null),
    ...
    void senderWithWrongRoleTagIsRejected() {
        tools.createChannel("wp-role-2",  "ACL by role",  null,  null,  "role:reviewer",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("junior-dave", "Junior dev", List.of("role:developer"), null, null);

        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-role-2", "junior-dave", "status", "hi", null, null, null, null, null, null, null, null),
    ...
    void mixedAclAcceptsInstanceIdAndCapabilityTag() {
        tools.createChannel("wp-mix-1",  "Mixed ACL",  null,  null,  "alice,capability:code-review",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("reviewer-eve", "Reviewer", List.of("capability:code-review"), null, null);

        // Instance ID match
        assertDoesNotThrow(
                () -> tools.sendMessage("wp-mix-1", "alice", "status", "direct", null, null, null, null, null, null, null, null));
        // Capability match
        assertDoesNotThrow(
                () -> tools.sendMessage("wp-mix-1", "reviewer-eve", "status", "cap", null, null, null, null, null, null, null, null));
    }

    @Test
    @TestTransaction
    void mixedAclRejectsNonMatchingSender() {
        tools.createChannel("wp-mix-2",  "Mixed ACL",  null,  null,  "alice,capability:code-review",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        tools.register("plain-bob", "No capabilities", List.of(), null, null);

        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-mix-2", "plain-bob", "status", "hi", null, null, null, null, null, null, null, null),
    ...
    void setChannelWritersAppliesAclToExistingChannel() {
        tools.createChannel("wp-scw-1",  "Initially open",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-scw-1", "mallory", "status", "after acl", null, null, null, null, null, null, null, null));
        // Alice is allowed
        assertDoesNotThrow(
                () -> tools.sendMessage("wp-scw-1", "alice", "status", "allowed", null, null, null, null, null, null, null, null));
    }

    @Test
    @TestTransaction
    void setChannelWritersToNullOrBlankClearsAcl() {
        tools.createChannel("wp-scw-2",  "Starts with ACL",  null,  null,  "alice",  null,  null,  null,  null,  null,  null,  null,  null,  null);

        // Blocked before clearing
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-scw-2", "bob", "status", "nope", null, null, null, null, null, null, null, null));
        ...
        // Bob now allowed
        assertDoesNotThrow(
                () -> tools.sendMessage("wp-scw-2", "bob", "status", "now allowed", null, null, null, null, null, null, null, null));
    }
    ...
    void createChannelDetailIncludesAllowedWriters() {
        ChannelDetail detail = tools.createChannel("wp-det-1",  "With ACL",  null,  null,  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void listChannelsIncludesAllowedWriters() {
        tools.createChannel("wp-det-2",  "ACL channel",  null,  null,  "carol",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void findChannelIncludesAllowedWriters() {
        tools.createChannel("wp-det-3",  "Searchable ACL",  null,  null,  "dave",  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void e2eThreeAgentsMixedAcl() {
        ...
        tools.createChannel("wp-e2e-1",  "Restricted channel",  "APPEND",  null,  "alice-agent,bob-agent",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        var aliceCmd = tools.sendMessage("wp-e2e-1", "alice-agent", "command", "alice work", null, null, null, null, null, null, null, null);
        assertDoesNotThrow(() -> tools.sendMessage("wp-e2e-1", "bob-agent", "response", "bob response",
                aliceCmd.correlationId(), aliceCmd.messageId(), null, null, null, null, null, null));

        // Carol is denied
        ToolCallException ex = assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-e2e-1", "carol-agent", "status", "carol intruding", null, null, null, null, null, null, null, null));
    ...
    void e2eCapabilityBasedAcl() {
        tools.createChannel("wp-e2e-2",  "Review channel",  "COLLECT",  null,  "capability:reviewer",  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        assertDoesNotThrow(() -> tools.sendMessage("wp-e2e-2", "sr-reviewer", "status", "lgtm", null, null, null, null, null, null, null, null));

        // Junior dev cannot
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-e2e-2", "jr-developer", "status", "me too", null, null, null, null, null, null, null, null));
        ...
        assertDoesNotThrow(() -> tools.sendMessage("wp-e2e-2", "jr-developer", "status", "now I can", null, null, null, null, null, null, null, null));
    }
    ...
    void e2eAclAndPauseAreIndependent() {
        tools.createChannel("wp-e2e-3",  "Test",  "APPEND",  null,  "alice",  null,  null,  null,  null,  null,  null,  null,  null,  null);

        // Pause channel — alice (listed) still blocked by pause
        tools.pauseChannel("wp-e2e-3", null);
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-e2e-3", "alice", "status", "paused", null, null, null, null, null, null, null, null));

        // Resume — alice can write, bob still ACL-blocked
        tools.resumeChannel("wp-e2e-3", null);
        assertDoesNotThrow(
                () -> tools.sendMessage("wp-e2e-3", "alice", "status", "resumed", null, null, null, null, null, null, null, null));
        assertThrows(ToolCallException.class,
                () -> tools.sendMessage("wp-e2e-3", "bob", "status", "still blocked", null, null, null, null, null, null, null, null));
    }
}
