...
class CollectEdgeCaseTest {
    ...
    void collectEmptyPollReturnsLastIdZeroNotInputCursor() {
        tools.createChannel("col-edge-2",  "COLLECT channel",  "COLLECT",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void collectAlwaysDeliversAllAccumulatedRegardlessOfCursorAfterClear() {
        tools.createChannel("col-edge-3",  "COLLECT channel",  "COLLECT",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void collectIgnoresLimitParameterDeliversAll() {
        tools.createChannel("col-edge-5",  "COLLECT channel",  "COLLECT",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        for (int i = 0; i < 10; i++) {
    ...
    void collectSecondReaderGetsNothingAfterFirstClears() {
        tools.createChannel("col-edge-6",  "COLLECT channel",  "COLLECT",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void collectSequentialCommittedReadsAreIdempotentAfterClear() {
        ...
        QuarkusTransaction.requiringNew().run(() -> {
            tools.createChannel(ch,  "COLLECT",  "COLLECT",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
