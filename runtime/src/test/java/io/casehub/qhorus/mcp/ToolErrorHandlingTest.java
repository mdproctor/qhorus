...
class ToolErrorHandlingTest {
    ...
    void sendMessage_pausedChannel_throwsToolCallException() {
        ...
        tools.createChannel("wrap-test-paused", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        tools.registerInstance("wrap-test-paused", "inst-1", null, null, null, null, null);
        tools.pauseChannel("wrap-test-paused", "inst-1");

        org.junit.jupiter.api.Assertions.assertThrows(
                ToolCallException.class,
                () -> tools.sendMessage("wrap-test-paused", "inst-1", "status", "hello", null, null, null, null, null, null, null, null));
    }
