...
class EventBypassAndBarrierRoleTest {
    ...
    void eventReplyWithInstanceTargetIsVisibleToAllReadersViaGetReplies() {
        ...
        tools.createChannel("evt-bp-1",  "Test",  "APPEND",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        tools.sendMessage("evt-bp-1", "system", "event", null, null, parent.messageId(), null, "instance:alice", null, null, null, null);
    ...
    void eventReplyWithCapabilityTargetIsVisibleToAllReadersViaGetReplies() {
        tools.createChannel("evt-bp-2",  "Test",  "APPEND",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        DispatchResult parent = tools.sendMessage("evt-bp-2", "alice", "command", "work item", null, null, null, null, null, null, null, null);

        tools.sendMessage("evt-bp-2", "system", "event", null, null, parent.messageId(), null, "capability:code-review", null, null, null, null);
    ...
    void nonEventTargetedReplyRemainsFilteredForWrongReader() {
        ...
        tools.createChannel("evt-bp-3",  "Test",  "APPEND",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        tools.sendMessage("evt-bp-3", "system", "response", "answer for alice", parent.correlationId(), parent.messageId(), null, "instance:alice", null, null, null, null);
    ...
    void barrierRoleBroadcastCountsOnlyAsSenderContribution() {
        ...
        tools.createChannel("barr-role-1",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        tools.sendMessage("barr-role-1", "alice", "status", "alice's contribution", null, null, null, "role:reviewer", null, null, null, null);
        ...
        tools.sendMessage("barr-role-1", "bob", "status", "bob's contribution", null, null, null, null, null, null, null, null);
    ...
    void barrierReleasesAfterEachContributorWritesRegardlessOfTarget() {
        ...
        tools.createChannel("barr-role-2",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        ...
        tools.sendMessage("barr-role-2", "bob", "status", "to alice", null, null, null, "instance:alice", null, null, null, null);
    ...
    void barrierStillBlocksWhenOnlyOneOfTwoRoleMembersHasWritten() {
        ...
        tools.createChannel("barr-role-3",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
