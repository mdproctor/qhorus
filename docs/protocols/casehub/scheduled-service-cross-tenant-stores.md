...
title: "@Scheduled and other no-request-context services must use CrossTenant*Store interfaces and explicit tenancyId — never inject CurrentPrincipal"
type: rule
scope: repo
