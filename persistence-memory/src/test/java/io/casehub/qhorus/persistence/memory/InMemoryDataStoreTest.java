...
class InMemoryDataStoreTest extends DataStoreContractTest {
    ...
    @Override protected void deleteClaim(UUID artefactId, UUID instanceId) { store.deleteClaim(artefactId, instanceId); }
    @Override protected int countClaims(UUID artefactId) { return store.countClaims(artefactId); }
