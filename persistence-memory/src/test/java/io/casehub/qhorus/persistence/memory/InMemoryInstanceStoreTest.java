...
class InMemoryInstanceStoreTest extends InstanceStoreContractTest {
    ...
    @Override protected Optional<Instance> findByInstanceId(String instanceId) { return store.findByInstanceId(instanceId); }
    ...
    void scan_staleOlderThan_returnsOnlyStale() {
        Instance fresh = store.put(instance("fresh-" + UUID.randomUUID()));
