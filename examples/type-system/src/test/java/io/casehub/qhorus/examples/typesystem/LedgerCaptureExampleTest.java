...
class LedgerCaptureExampleTest {
    ...
    void allNineMessageTypes_produceLedgerEntries() {
        tools.createChannel("ledger-ex-all-types", "All 9 message types example", "APPEND", null, null, null, null, null, null, null, null, null, null);
    ...
    void obligationLifecycle_commandDone_causalChainPresent() {
        tools.createChannel("ledger-ex-chain", "Causal chain example", "APPEND", null, null, null, null, null, null, null, null, null, null);
    ...
    void listLedgerEntries_typeFilter_obligationTypesOnly() {
        tools.createChannel("ledger-ex-filter", "Type filter example", "APPEND", null, null, null, null, null, null, null, null, null, null);
