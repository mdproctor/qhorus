...
public record Commitment(
    ...
    public Builder toBuilder() {
        return new Builder()
                       ...
                       .capabilityTag(capabilityTag).createdAt(createdAt);
    }
    ...
    public static final class Builder {
        ...
        public Builder requester(String v)        {
                                                      this.requester = v;
                                                      return this;
                                                  }

        public Builder obligor(String v)          {
                                                      this.obligor = v;
                                                      return this;
                                                  }

        public Builder state(CommitmentState v)   {
                                                      this.state = v;
                                                      return this;
                                                  }
        ...
        public Builder delegatedTo(String v)      {
                                                      this.delegatedTo = v;
                                                      return this;
                                                  }

        public Builder parentCommitmentId(UUID v) {
                                                      this.parentCommitmentId = v;
                                                      return this;
                                                  }
        ...
        public Builder capabilityTag(String v)    {
                                                      this.capabilityTag = v;
                                                      return this;
                                                  }
        ...
        public Commitment build() {
            return new Commitment(id, correlationId, channelId, messageType,
                                  ...
                                  resolvedAt, delegatedTo, parentCommitmentId, tenancyId,
                                  capabilityTag, createdAt);
        }
    }
}
